...
The fundamental dice mechanic in \GammaRP{} is based on 12 sided dice, and rolls several at a time. If you intend to play the game on a real physical tabletop (rather than one of the increasingly popular virtual ones), you may want to obtain a few dozen 12 sided dice.
...
\typeout{Point C table counter = \arabic{table}}
\GRPbitepar[right]{0pt,0pt,0pt,0pt,8.9mm,10.5mm,9.5mm}\GRPparabgsvg[height=1.4cm,side=right,shift={(-1.6cm,-1.3cm)}]{art/onedice}
...
\typeout{Point F table counter = \arabic{table}}
