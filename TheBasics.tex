...
\textit{Y} is the \emph{advantage} on the roll, which indicates that the top \textit{Y} numbers of a die pass the success threshold.
...
\begin{GRPtabular}{l/0.16,c/0.53,r\scshape/0.31}
...
Another way to look at this is-- if you can sum the advantage with the value of any die in your roll and get a number greater than 12, your roll is successful. An advantage of 0 is the exception, which still is successful if any dice rolls a 12.
