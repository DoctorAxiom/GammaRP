...
\index{Additional Disadvantage}If the GM or the rules specify you take \emph{Z} additional disadvantage- then you roll with \emph{Z} lower advantage than you ordinarily would. Remember that \emph{-Z} advantage is the same as \emph{Z} disadvantage. Rolling with additional disadvantage may still leave some net advantage to the roll left over.
