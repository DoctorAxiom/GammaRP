...
{%
	...
	\renewcommand{\caption}[2][]{%
		\def\@captype{#1}%
		\begin{tcolorbox}[ignore nobreak,colback=\ChapterBackgroundTint!75!black,colframe=\ChapterBackgroundTint!75!black,coltext=\ChapterBackgroundTint!10!white,size=title,show bounding box]%
...
\AddToHook{env/GRPfig-wide/after}{\begin{multicols}{2}}
\AddToHook{env/GRPfig-wide/before}{\end{multicols}}
