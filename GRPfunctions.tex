...
\int_new:N \l_count_macro_int

% Count macro occurrences with one optional argument
% #1 = body, #2 = macro name
\cs_new:Npn \macrocount #1#2{
    \seq_new:N \l_tmp_seq
    \tl_set:Nx \l_tmpa_tl { #1 }
    \tl_map_inline:Nn \l_tmpa_tl {
        \if_meaning:cn { #2 } { 
            \seq_put_right:Nn \l_tmp_seq { ##1 }
        }
    }
    \seq_count:N \l_tmp_seq
}
\ExplSyntaxOff
...
\NewEnviron{GRPtabular}[1]{% #1 = customcolumnspec
	...
	\foreach \grpalign/\grpwidth in {#1}{%
		\IfStrEqCase{\grpalign}{%
		{l}{\g@addto@macro\GRPtablespec{>{\raggedright\arraybackslash}}}%
		{c}{\g@addto@macro\GRPtablespec{>{\centering\arraybackslash}}}%
		{r}{\g@addto@macro\GRPtablespec{>{\raggedleft\arraybackslash}}}%
		}%
